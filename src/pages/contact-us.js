                    ...
                    <Col as="section">
                        ...
                        <div className="d-block mb-3 border-bottom">
                            <ul className="list-group mb-3">
                                <li className="list-group-item"><FaPhoneSquareAlt size={32} className="text-warning me-2" /> <a href="tel:+19897089620" aria-label="Call Absolutely Gorgeous Interiors" title="Call Absolutely Gorgeous Interiors" className="fw-medium text-decoration text-uppercase my-2 mx-auto text-muted">Call Mark Now (989) 708-9620</a></li>
                            ...
                            <ul className="list-group mb-3">
                                <li className="list-group-item"><FaPhoneSquareAlt size={32} className="text-warning me-2" /> <a href="tel:+12318831521" aria-label="Call Absolutely Gorgeous Interiors" title="Call Absolutely Gorgeous Interiors" className="fw-medium text-decoration text-uppercase my-2 mx-auto text-muted">Call Don Now (231) 883-1521</a></li>
